...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordView = (EditText) findViewById(R.id.editPwd);
        ...
        Button btGuestLogin = (Button)findViewById(R.id.btGuest);
        btGuestLogin.setOnClickListener(new Button.OnClickListener() {
            @Override
        ...
        txtForgotPwd.setOnClickListener(new TextView.OnClickListener() {
            @Override
            public void onClick(View view) {
                forgotPwd();
            }
        ...
        txtSignup.setOnClickListener(new TextView.OnClickListener() {
            @Override
            public void onClick(View view) {
                signUp();
            }
    ...
    private void guestlogin() {
        ...
        boolean orgValue = prefManager.isFirstTimeLaunch();
